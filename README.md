...
- Ultra Performance 25% mode is disabled for now because it can exceed the MetalFX 3x upscaling limit
...
- Ultra Performance 25% 모드는 MetalFX 3x 업스케일 제한을 초과할 수 있어 현재 비활성화되어 있습니다.
